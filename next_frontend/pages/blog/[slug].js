        ...
        <div class="mx-auto max-w-4xl">
          <div class="">
            ...
            <div class="flex items-center pt-5 md:pt-10">
                <img src={urlFor(author.image).width(200).height(200).url()}
                  class="h-20 w-20 rounded-full border-2 border-grey-70 shadow"
                  alt="author image" />
              <div class="pl-5">
                <span class="block font-body text-xl font-bold text-grey-10">{author.title}</span>
          ...
          <div
            ...
            <div class="w-3/4 sm:w-2/5 lg:w-1/4 xl:w-1/5">
              <img src={urlFor(author.image).width(200).height(200).url()} class="rounded-full shadow" alt="author image" />
            </div>
...
export const getServerSideProps = async (context) => {
  ...
  const auth = `*[_type == "author"][1]`;
  const author = await client.fetch(auth);
  return {
    props: {
      blog, profile, author
    }
