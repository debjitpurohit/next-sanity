...
// //have to install next-sanity then add gets
// //https://www.sanity.io/docs/query-cheat-sheet -- query cheat sheet groq
// export async function getServerSideProps() {
//   const client = createClient({
//     projectId: "rsl8zxlf",// project id
//     dataset: "production",
//     useCdn: false,
//   });
  ...
  return (
    <><>
      ...
      <div className="relative bg-cover bg-center bg-no-repeat py-8" style={{ backgroundImage: "url(/assets/img/bg-hero.jpg)" }}>
        ...
        <div className="container relative z-30 pt-20 pb-12 sm:pt-56 sm:pb-48 lg:pt-64 lg:pb-48">
          <div className="flex flex-col items-center justify-center lg:flex-row">
            <div className="rounded border-8 border-primary shadow-xl">
              <img src={builder.image(profile.image).width(600).url()} className="h-48 rounded sm:h-56" alt="author" />
            </div>
      ...
      <div className="bg-grey-50 " id="about">
        <div className="container flex flex-col items-center py-16 md:py-30 lg:flex-row">
          <div className="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
            <h2 className="font-header text-4xl font-semibold uppercase text-primary sm:text-5xl lg:text-6xl my-20 mx-20">
              Who am I?
            </h2>
          ...
          <div className="mx-auto grid w-full grid-cols-1 gap-6 pt-12 sm:w-3/4 lg:w-full lg:grid-cols-3 xl:gap-10">
            ...
            {blogs.map((item) => {
              return <Link key={item.slug.current} href={"/blog/" + item.slug.current} className="shadow">
                <div><div
                style={{"backgroundImage": `url(${builder.image(item.blogimage).width(600).url() || '/post-01.png'})`}}
